tinyMCE.init
        # ha, eine Sache schonmal gelernt: in Coffeescript fangen Kommentare
        # wie in Perl oder Rails mit # an. () kann man hier auch weg lassen.
        #####################################################################
        # General options
        mode : "textareas",
        theme : "advanced",
        plugins :    "autolink,lists,
                      spellchecker,pagebreak,style,layer,
                      table,save,advhr,advimage,
                      advlink,emotions,iespell,inlinepopups,
                      insertdatetime,preview,media,searchreplace,
                      print,contextmenu,paste,directionality,
        ...
        theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,
                                  ...
                                  link,unlink,anchor,image,cleanup,help,code,|, print,|",
        ...
        theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,
                                  ...
                                  insertfile,insertimage,forecolor,
                                  backcolor,|,insertdate,inserttime,preview,|,fullscreen",
